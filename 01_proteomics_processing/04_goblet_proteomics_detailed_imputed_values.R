...
ctrl <- read.csv("goblet_cntrl_b12_b15.csv")
il13 <- read.csv("goblet_il13_f7_f10.csv")
...
write_xlsx(results_detailed_df, "goblet_imputed_detailed_results.xlsx")
write.csv(results_detailed_df, "goblet_imputed_detailed_results.csv", row.names = FALSE)
