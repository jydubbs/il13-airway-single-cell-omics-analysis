...
write_xlsx(sig_hits_annotated, "ver_3_secretory_sig_hits_results.xlsx")
write.csv(sig_hits_annotated, "ver_3_secretory_sig_hits_detailed_results.csv", row.names = FALSE)
