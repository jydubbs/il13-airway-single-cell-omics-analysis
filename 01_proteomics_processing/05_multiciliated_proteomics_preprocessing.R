...
ctrl_values <- ctrl[,5:7]
il13_values <- il13[,5:7]
...
write_xlsx(sig_hits_annotated, "ver_3_mccs_sig_hits_results.xlsx")
write.csv(sig_hits_annotated, "ver_3_mccs_sig_hits_results.csv", row.names = FALSE)
