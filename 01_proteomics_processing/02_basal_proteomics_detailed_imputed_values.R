# This script creates a separate excel/csv table showing where missing values and imputation were, and what the imputed value was
...
write_xlsx(results_detailed_df, "basal_imputed_detailed_results.xlsx")
write.csv(results_detailed_df, "basal_imputed_detailed_results.csv", row.names = FALSE)
